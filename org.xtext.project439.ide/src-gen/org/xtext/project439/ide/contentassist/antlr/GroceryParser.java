...
public class GroceryParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, GroceryGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getWarehouseAccess().getElementsAssignment_6(), "rule__Warehouse__ElementsAssignment_6");
			...
			builder.put(grammarAccess.getExperationDateAccess().getDateAssignment_4(), "rule__ExperationDate__DateAssignment_4");
