...
public class ExportXMI {
	...
	public static void main(String[] args) {
		...
		Injector injector = new GroceryStandaloneSetup().createInjectorAndDoEMFRegistration();
	    XtextResourceSet resourceSet = injector.getInstance(XtextResourceSet.class);
	    
	    //change this to the path of your input turn file
	    String inputURI = "/home/ian/xtext-workspace/439Project/GModel/src/secondTest.grocery";
	    //change this to the path of your output xmi file
	    String outputURI = "/home/ian/xtext-workspace/439Project/GModel/src/secondTest.xmi";
	    ...
	    GroceryPackage.eINSTANCE.eClass();
	    resourceSet.getPackageRegistry().put(GroceryPackage.eNS_URI, GroceryPackage.eINSTANCE);
	    //gets xtext resource
